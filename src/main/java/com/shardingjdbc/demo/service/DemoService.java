...
import com.shardingjdbc.demo.entity.OrderItem;
import com.shardingjdbc.demo.repository.OrderItemRepository;
...
public class DemoService {
    ...
    public void demo() {
        ...
        List<Integer> orderItemIds = new ArrayList<>(10);
        System.out.println("1.Insert--------------");
        for (int i = 0; i < 10; i++) {
            Order order = new Order();
            order.setUserId(51);
            Integer orderId = orderRepository.save(order).getOrderId();
